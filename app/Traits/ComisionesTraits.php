...
trait ComisionesTraits
{

    private function comisiones_anular_asiento($asiento_id, $usuario_id, $fecha)
    {
    ...
    private function lista_comisiones($empresa_id, $periodo_id, $flujo_caja_id)
    {

        $asientos_registrados = WEBAsiento::where('COD_CATEGORIA_TIPO_ASIENTO', 'TAS0000000000007') //TAS0000000000002
            ...
            //dd($asientos_registrados);

        $comisiones = TESOperacionCaja::where('TES.OPERACION_CAJA.COD_FLUJO_CAJA', $flujo_caja_id) //'IICHIM0000000020')
            ->where('TES.OPERACION_CAJA.COD_CATEGORIA_OPERACION_CAJA', 'OPC0000000000002')
    ...
    public function comisiones_monto_total_asiento($lista_comisiones, $seleccionados)
    {

        $monto = 0.0000;

        foreach ($lista_comisiones as $index => $item) {
    ...
    public function comisiones_asiento_modelo($data_archivo)
    {
    ...
    public function comisiones_cabecera_asiento($periodo, $empresa_id, $monto_total, $glosa, $moneda_id, $moneda, $tipo_cambio, $tipo_referencia)
    {
    ...
    public function comisiones_detalle_asiento($array_asiento_modelo, $periodo, $empresa_id, $moneda_id, $moneda, $monto_total, $tipo_cambio)
    {
