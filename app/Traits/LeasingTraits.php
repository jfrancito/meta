...
trait LeasingTraits
{
    ...
    private function leasing_anular_asiento($asiento_id, $usuario_id, $fecha)
    {
    ...
    private function lista_leasing($empresa_id, $periodo_id, $movimiento_id, $banco_id = '')
    {
        ...
        //->whereNotIn('TES.OPERACION_CAJA.COD_OPERACION_CAJA', $asientos_registrados)
            ...
            ->orderBy('CON.PAGARE_DETALLE.FEC_VENCIMIENTO')
            ->select('CON.PAGARE.COD_PAGARE', 'CON.PAGARE.NRO_PAGARE', 'CON.PAGARE.COD_EMPR_BANCO', 'CON.PAGARE.TXT_EMPR_BANCO', 'CON.PAGARE_DETALLE.FEC_CUOTA',
                'CON.PAGARE_DETALLE.FEC_VENCIMIENTO', 'CON.PAGARE.CAN_MONTO_MN', 'CON.PAGARE_DETALLE.CAN_CUOTA_MN',
                'CON.PAGARE_DETALLE.CAN_INT_MENSUAL_MN', 'CON.PAGARE_DETALLE.COD_DETALLE', 'CON.PAGARE.TXT_GLOSA')
            ->get()
            ->ToArray();
    ...
    public function leasing_monto_total_asiento($lista_leasing, $cod_pagare, $cod_detalle_pagare)
    {
    ...
    public function leasing_asiento_modelo($data_archivo, $nro_linea, $cod_banco, $empresa_id)
    {

        $array_detalle_asiento = array();

        if ($data_archivo == 'agregar-leasing') {
    ...
    public function leasing_cabecera_asiento($periodo, $empresa_id, $monto_total, $glosa, $moneda_id, $moneda, $tipo_cambio, $tipo_referencia)
    {
    ...
    public function leasing_detalle_asiento($array_asiento_modelo, $periodo, $empresa_id, $moneda_id, $moneda, $monto_total, $tipo_cambio)
    {
