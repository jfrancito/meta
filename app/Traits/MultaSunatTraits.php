...
trait MultaSunatTraits
{
    ...
    private function multa_sunat_anular_asiento($asiento_id, $usuario_id, $fecha)
    {
    ...
    private function lista_multa_sunat($empresa_id, $periodo_id, $movimiento_id)
    {
        ...
        $multa_sunat = TESOperacionCaja::where('TES.OPERACION_CAJA.COD_ITEM_MOVIMIENTO', $movimiento_id) //'IICHIM0000000020')
    ...
    public function multa_sunat_asiento_modelo($data_archivo)
    {

        $array_detalle_asiento = array();

        if ($data_archivo == 'agregar-multa-sunat') {

            $array_nuevo_asiento = array(
                "cuenta_nrocuenta" => '659201',
                "d_h" => 'D',
                "linea" => '1',
            );
    ...
    public function multa_sunat_cabecera_asiento($periodo, $empresa_id, $monto_total, $glosa, $moneda_id, $moneda, $tipo_cambio, $tipo_referencia)
    {
    ...
    public function multa_sunat_detalle_asiento($array_asiento_modelo, $periodo, $empresa_id, $moneda_id, $moneda, $monto_total, $tipo_cambio)
    {
