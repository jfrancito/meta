$(document).ready(function(){
    ...
    $(".movilidad").on('click','.crearcuentacontable', function() {
        ...
        var data_archivo            =   $(this).attr('data_archivo'); //agregaritf
        ...
        ajax_modal(data,"/ajax-modal-configuracion-itf-cuenta-contable",
                  "modal-configuracion-itf-cuenta-contable","modal-configuracion-itf-cuenta-contable-container");
    ...
    $(".movilidad").on('click','.buscaritf', function() {
        ...
        ajax_normal(data,"/ajax-registro-itf");
