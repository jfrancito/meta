$(document).ready(function(){
    ...
    $(".kardexcascara").on('click','.descargararchivo', function() {
    ...
    $(".kardexcascara").on('click','.buscarple', function() {
    ...
    $(".kardexcascara").on('change','#anio', function() {
    ...
    $(".kardexcascara").on('click','.agregartranferenciaproducto', function() {
    ...
    $(".kardexcascara").on('click','.btn_calcular_cu', function() {
    ...
    $(".kardexcascara").on('click','.btn-guardar-configuracion', function() {
    ...
    $(".kardexcascara").on('click','.buscarsaldoinicial', function() {
    ...
    $(".kardexcascara").on('dblclick','.dobleclickac', function(e) {
    ...
    $(".kardexcascara").on('dblclick','.dobleclickpc', function(e) {
