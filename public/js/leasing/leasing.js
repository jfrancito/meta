$(document).ready(function(){
    ...
    $(".movilidad").on('click','.crearcuentacontable', function() {
        ...
        var data_archivo            =   $(this).attr('data_archivo'); //agregarleasing
        ...
        ajax_modal(data,"/ajax-modal-configuracion-leasing-cuenta-contable",
                  "modal-configuracion-leasing-cuenta-contable","modal-configuracion-leasing-cuenta-contable-container");
    ...
    $(".movilidad").on('click','.buscar-leasing', function() {
        ...
        ajax_normal(data,"/ajax-registro-leasing");
