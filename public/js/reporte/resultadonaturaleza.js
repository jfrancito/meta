$(document).ready(function(){
    ...
    $(".resultadonaturaleza").on('click','.descargararchivo', function() {
    ...
    $(".resultadonaturaleza").on('click','.buscarrn', function() {
        ...
        ajax_normal(data,"/ajax-buscar-resultado-naturaleza");

    });


    $(".resultadonaturaleza").on('change','#anio', function() {
