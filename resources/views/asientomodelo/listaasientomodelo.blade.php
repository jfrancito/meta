          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Asiento Modelo
                  <div class="tools tooltiptop">
                    <a href="#" class="tooltipcss opciones buscarasientomodelo">
                      <span class="tooltiptext">Buscar Asiento Modelo</span>
                      <span class="icon mdi mdi-search"></span>
                    </a>

                    <a href="{{ url('/agregar-asiento-modelo/'.$idopcion) }}" class="tooltipcss">
                      <span class="tooltiptext">Crear Asiento Modelo</span>
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    @include('asientomodelo.ajax.alistaasientomodelo')
                  </div>
