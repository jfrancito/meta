<div class="panel panel-default">
    <div class="tab-container">
      <ul class="nav nav-tabs">
        <li class="active"><a href="#comisiones" data-toggle="tab">Lista Pagos Comisiones</a></li>
      ...
      <div class="tab-content">
        <div id="comisiones" class="tab-pane active cont">
          @include('comisiones.ajax.comisiones')
        </div>
