                ...
                <div class="tools tooltiptop">
                  <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="menudespacho" style="margin: 7px -169px 0px;">
                          ...
                          <li>
                            <a href="#" class='crearcuentacontable' data_tabla = 'general' data_archivo = 'agregarcomisiones' >
...
<table id="dtcomisiones" class="table table-striped table-borderless table-hover td-color-borde td-padding-7 listatablageneral">
  <thead>
    <tr>
      <th>MEDIO DE PAGO</th>
      <th>BANCO</th>
