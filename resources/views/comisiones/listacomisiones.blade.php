...
@section('section')
  ...
  <div class="be-content contenido movilidad">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Registro Comisiones
                  <div class="tools tooltiptop">
                    <a href="#" class="tooltipcss opciones buscarcomision">
                      <span class="tooltiptext">Buscar Comisi&oacute;n</span>
                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                    <div class="col-xs-12">
                      ...
                      <form method="POST"
                      id="formguardar"
                      action="{{ url('/comisiones-guardar-data') }}" 
                  ...
                  <div class='listajax'>
                    @include('comisiones.ajax.alistacomisiones')
                  </div>
    ...
    @include('comisiones.modal.mcomisionescc')
  </div>
...
@section('script')
  ...
  <script src="{{ asset('public/js/comisiones/comisiones.js?v='.$version) }}" type="text/javascript"></script>
