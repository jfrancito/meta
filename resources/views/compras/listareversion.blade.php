          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Reversion de igv
                  <div class="tools tooltiptop">

                    <a href="#" class="tooltipcss opciones agregacuentacontable" >
                      <span class="tooltiptext">Crear asiento contable</span>
                      <span class="icon mdi mdi-plus-circle-o"></span>
                    </a>

                    <a href="#" class="tooltipcss opciones buscarreversion">
                      <span class="tooltiptext">Buscar Reversion</span>
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    @include('compras.ajax.alistareversion')
                  </div>
