...
<div class="modal-body">
	...
	<form method="POST"
	id="formguardar"
	action="{{ url('/reversion-guardar-data/'.$idopcion) }}" 
	...
	<div class="modal-footer">
			...
			<button type="submit" data-dismiss="modal" class="btn btn-success btn-guardar-configuracion cargando">Guardar</button>
