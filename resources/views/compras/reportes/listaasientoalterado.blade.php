          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Asientos alterados de compras
                  ...
                  <div class="tools tooltiptop">
                    <div class="dropdown">
                      ...
                      <a href="#" class="tooltipcss opciones buscarasientoalterado">
                        <span class="tooltiptext">Buscar asientos alterados</span>
                        <span class="icon mdi mdi-search"></span>
                      </a>
                      <ul class="dropdown-menu" aria-labelledby="menudespacho" style="margin: 7px -169px 0px;">
                        <li>
                          <a href="#" class='descargararchivoaa' data_archivo = 'registrocompra'><b>Asiento alterado excel</b> <span class="mdi mdi-check-circle"></span></a>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                    <div class="col-xs-12">
                      ...
                      id="formdescargar"
                      target="_blank"
                      action="{{ url('/descargar-asiento-alterado-excel') }}" 
                  ...
                  <div class='listajax'>
                    @include('compras.reportes.ajax.alistaasientoalterado')
                  </div>
