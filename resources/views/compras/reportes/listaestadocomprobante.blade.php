...
@section('section')
  ...
  <div class="be-content contenido reportecompra">
    <div class="main-content container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Estado de comprobante de compras
                  ...
                  <div class="tools tooltiptop">
                    <div class="dropdown">
                      ...
                      <a href="#" class="tooltipcss opciones buscarestadocomprobante">
                        <span class="tooltiptext">Buscar estado de comprobante</span>
                        <span class="icon mdi mdi-search"></span>
                      </a>
                      <ul class="dropdown-menu" aria-labelledby="menudespacho" style="margin: 7px -169px 0px;">
                        <li>
                          <a href="#" class='descargararchivo' data_archivo = 'registrocompra'><b>Estado comprobante excel</b> <span class="mdi mdi-check-circle"></span></a>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                    <div class="col-xs-12">
                      ...
                      id="formdescargar"
                      target="_blank"
                      action="{{ url('/descargar-estado-comprobante-excel') }}" 
                  ...
                  <div class='listajax'>
                    @include('compras.reportes.ajax.alistaestadocomprobante')
                  </div>
...
@section('script')
  ...
  <script src="{{ asset('public/js/reporte/compra.js?v='.$version) }}" type="text/javascript"></script>
