          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Movimiento Kardex Envases
                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                    <div class="col-xs-12">
                      ...
                      id="formdescargar"
                      target="_blank"
                      action="{{ url('/descargar-excel-kardex-cascara') }}" 
...
@section('script')
  ...
  <script src="{{ asset('public/js/kardex/kardexcascara.js?v='.$version) }}" type="text/javascript"></script>
