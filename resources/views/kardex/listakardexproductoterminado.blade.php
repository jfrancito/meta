...
@section('section')
  ...
  <div class="be-content contenido kardexcascara">
    <div class="main-content container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Movimiento Kardex Producto Terminado
                  <div class="tools tooltiptop">
                    ...
                    <div class="dropdown">
                      ...
                      <a href="#" class="tooltipcss opciones buscarmovimientokardex">
                        <span class="tooltiptext">Buscar Movimiento Producto Terminado</span>
                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                    <div class="col-xs-12">
                      ...
                      id="formdescargar"
                      target="_blank"
                      action="{{ url('/descargar-excel-kardex-producto-terminado') }}" 
...
<!--                       <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                 ...
                 <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                          <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja" >
                              {!! Form::select( 'tipo_producto_id', $combo_tipo_producto, $sel_tipo_producto,
                                                [
                                                  'class'       => 'select2 form-control control input-xs' ,
                                                  'id'          => 'tipo_producto_id',
                                                  'required'    => '',
                  ...
                  <div class='listajax'>
                    @include('kardex.ajax.alistakardexpt')
                  </div>
...
@section('script')
  ...
  <script src="{{ asset('public/js/kardex/kardexpt.js?v='.$version) }}" type="text/javascript"></script>
