...
@section('section')
  ...
  <div class="be-content contenido movilidad">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Registro de Asientoss Leasing
                  <div class="tools tooltiptop">
                    <a href="#" class="tooltipcss opciones buscar-leasing">
                      <span class="tooltiptext">Buscar Leasing</span>
                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                    <div class="col-xs-12">
                      ...
                      <form method="POST"
                      id="formguardar"
                      action="{{ url('/leasing-guardar-data') }}" 
                  ...
                  <div class='listajax'>
                    @include('leasing.ajax.alistaleasing')
                  </div>
    ...
    @include('leasing.modal.mleasingcc')
  </div>
...
@section('script')
  ...
  <script src="{{ asset('public/js/leasing/leasing.js?v='.$version) }}" type="text/javascript"></script>
