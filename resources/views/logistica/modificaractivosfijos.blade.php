...
@section('script')
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        if($(".info-depreciacion").text() != "SIN DEPRECIAR"){
            $("#tipoactivo").prop('disabled', true);
            $("#activoprincipal").prop('disabled', true);    
        }
        
        if($("#estado option:selected").text()=='BAJA'){
            $("#tipoactivo").prop('disabled', true);
            $("#activoprincipal").prop('disabled', true);
        }

        $("#estado").change(function() {
          if($("#estado option:selected").text()=='OPERATIVO'){
            if($(".info-depreciacion").text() == "SIN DEPRECIAR"){
              $("#tipoactivo").prop('disabled', false);            
              if($("#tipoactivo option:selected").text()=='COMPUESTO'){
                $("#activoprincipal").prop('disabled', false);            
              } else {
                $("#activoprincipal").prop('disabled', true);            
