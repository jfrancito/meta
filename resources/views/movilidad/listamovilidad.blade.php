          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Registro Movilidad
                  <div class="tools tooltiptop">
                    <a href="#" class="tooltipcss opciones buscarmovilidad">
                      <span class="tooltiptext">Buscar Movilidad</span>
...
@section('script')
  ...
  <script src="{{ asset('public/js/movilidad/movilidad.js?v='.$version) }}" type="text/javascript"></script>
