...
@section('section')
  ...
  <div class="be-content contenido movilidad">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Registro de Asientos Multa Sunat
                  <div class="tools tooltiptop">
                    <a href="#" class="tooltipcss opciones buscar-multa-sunat">
                      <span class="tooltiptext">Buscar Multa</span>
                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                    <div class="col-xs-12">
                      ...
                      <form method="POST"
                      id="formguardar"
                      action="{{ url('/multa-sunat-guardar-data') }}" 
                  ...
                  <div class='listajax'>
                    @include('multasunat.ajax.alistamultasunat')
                  </div>
    ...
    @include('multasunat.modal.mmultasunatcc')
  </div>
...
@section('script')
  ...
  <script src="{{ asset('public/js/multa-sunat/multa-sunat.js?v='.$version) }}" type="text/javascript"></script>
