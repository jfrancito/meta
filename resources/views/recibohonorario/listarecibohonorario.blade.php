...
@section('section')
  ...
  <div class="be-content contenido recibohonorario">
    <div class="main-content container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Listado de recibo por honorarios
                  <div class="tools tooltiptop">

                    <a href="#" class="tooltipcss opciones buscarcompras">
                      <span class="tooltiptext">Buscar recibo por honorarios</span>
                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                      ...
                      <div class='listajax'>
                        @include('recibohonorario.ajax.alistarecibohonorario')
                      </div>
                </div>
    ...
    @include('recibohonorario.modal.mrecibohonorario')
  </div>
...
@section('script')
  ...
  <script src="{{ asset('public/js/recibohonorario/recibohonorario.js?v='.$version) }}" type="text/javascript"></script>
