...
@section('section')
  ...
  <div class="be-content contenido registrodiario">
            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-12 widget-chart-container">
                      <div class="widget-chart-info">
                        <ul class="chart-legend-horizontal">
                          <li><span class="main-chart-color1"></span> Emitido</li>
                          <li><span class="main-chart-color2"></span> Anulado</li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div class='listajax'>
                    @include('registrodiario.ajax.alistaregistrodiario')
                  </div>
