...
@section('section')
  ...
  <div class="be-content contenido balancecomprobacion">
    <div class="main-content container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Balance Comprobacion
                  <div class="tools tooltiptop">
                    ...
                    <div class="dropdown">
                      ...
                      <a href="#" class="tooltipcss opciones buscarbalancecomprobacion">
                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                    <div class="col-xs-12">
                      ...
                      id="formdescargar"
                      target="_blank"
                      action="{{ url('/descargar-balance-comprobacion-excel') }}" 
