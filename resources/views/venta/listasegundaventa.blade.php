...
@section('section')
  ...
  <div class="be-content contenido segundaventa">
            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    @include('venta.ajax.alistasegundaventa')
                  </div>
                </div>
              </div>
            </div>
    ...
    @include('venta.modal.msegundaventa')
  </div>
...
@section('script')
  ...
  <script src="{{ asset('public/js/venta/segundaventa.js?v='.$version) }}" type="text/javascript"></script>
